...
class State():
    def __init__(self, state: Union[EmptyState, State], move: Move = None):
        ...
        if move is not None:
            ...
            self.score = state.score - move[0].score - move[1].score + new_gem.score
    ...
    def _update_score(self):
        ...
        self._free = free
        self.potential_score = keys + 3 * min(tops, bottoms, free)
        self.score = keys - .01 * lock_penalty
...
class Solver():
    ...
    def show_results(self):
        ...
        print(f" -- Score: {self.best.score:0.2f} out of {len(self.end_states)} evaluated games.")
